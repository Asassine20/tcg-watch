  ...
  const features = [
    {
      ...
      description:
        "Monitor TCGPlayer market trends with daily updates on price spikes and dips.",
      icon: "flat-color-icons:bar-chart",
    },
    {
      name: "Daily Email Alerts",
      description:
        "Get notified when your tracked cards or sealed products have significant price changes.",
      icon: "flat-color-icons:invite",
    },
    {
      name: "User Dashboard",
      description:
        "Manage your tracked cards, set price alerts, and view historical price trends.",
      icon: "flat-color-icons:settings",
    },
    {
      name: "Subscription Plans",
      description:
        "Choose from free or premium plans to track more cards and get advanced analytics.",
      icon: "flat-color-icons:business",
    },
    {
      name: "Market Insights",
      description:
        "Analyze past price trends to predict the best times to buy and sell your cards.",
      icon: "flat-color-icons:pie-chart",
    },
    {
      name: "TCGPlayer Integration",
      description:
        "Direct links to TCGPlayer listings so you can buy or sell cards instantly.",
      icon: "flat-color-icons:shop",
    },
    {
      name: "Custom Price Alerts",
      description:
        "Set specific price thresholds and receive instant alerts when met.",
...

    {
      ...
      description:
        "Filter by card set, rarity, price range, and more for precise market tracking.",
      icon: "flat-color-icons:search",
    },
    {
      name: "Community-Driven",
      description:
        "Join a growing community of TCG investors and get insights from other collectors.",
  ...
  <div class="pt-20 pb-8 px-7">
    <div class="max-w-lg mx-auto text-center">
      ...
      <div class="mt-4 text-xl font-bold">
        ...
        <span class="decoration-secondary decoration-[3px] md:decoration-[4px]">
        ...
        <div class="min-w-[270px] lg:min-w-[420px] flex mt-6 lg:mt-0">
          <div class="my-auto">
            ...
            <div class="px-4 mt-6 text-lg md:text-xl">
              ...
              <a
                href="https://yourtool.com/demo"
                class="link font-bold"
                target="_blank">our demo</a
